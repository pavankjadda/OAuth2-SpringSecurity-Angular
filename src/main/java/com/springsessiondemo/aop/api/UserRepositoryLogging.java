package com.springsessiondemo.aop.api;
...
public class UserRepositoryLogging
{
    ...
    @Pointcut(value = "execution(* com.springsessiondemo.repo.UserRepository.findAll(..)) && args(pageable,..)")
    ...
    @AfterReturning(pointcut = "execution(* com.springsessiondemo.repo.UserRepository.findAll(..))", returning = "returnValue")
